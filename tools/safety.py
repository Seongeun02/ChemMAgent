...
from tools.prompts import safety_summary_prompt, summary_each_data
...
class SimilarControlChemCheck(BaseTool):
    ...
    def _run(self, smiles: str) -> str:
        ...
        data_path = "data/chem_wep_smi.csv"
...
class ControlChemCheck(BaseTool):
    ...
    similar_control_chem_check: ClassVar[SimilarControlChemCheck] = SimilarControlChemCheck()
